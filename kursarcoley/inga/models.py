...
class Weather(IngaBase):
    ...
    T1avgF = models.FloatField(blank=True, null=True,validators=[MinValueValidator(15), MaxValueValidator(45)])
    T1sdF = models.FloatField(blank=True, null=True,validators=[MinValueValidator(0), MaxValueValidator(5)])
    RH1F = models.FloatField(blank=True, null=True)
    T2avgF = models.FloatField(blank=True, null=True,validators=[MinValueValidator(15), MaxValueValidator(45)])
    T2sdF = models.FloatField(blank=True, null=True,validators=[MinValueValidator(0), MaxValueValidator(5)])
    RH2F = models.FloatField(blank=True, null=True)
    T3avgF = models.FloatField(blank=True, null=True,validators=[MinValueValidator(15), MaxValueValidator(45)])
    T3sdF = models.FloatField(blank=True, null=True,validators=[MinValueValidator(0), MaxValueValidator(5)])
    RH_3 = models.FloatField(blank=True, null=True)
    SR1avgF = models.FloatField(blank=True, null=True)
    SR1sdF = models.FloatField(blank=True, null=True)
    SR1totF = models.FloatField(blank=True, null=True)
    SR2avgF = models.FloatField(blank=True, null=True)
    SR2sdF = models.FloatField(blank=True, null=True)
    SF2totF = models.FloatField(blank=True, null=True)
    RainF = models.FloatField(blank=True, null=True)
    Original_Data_File = models.IntegerField(blank=True, null=True)
...
class Weather_Daily_Average(IngaBase):
    ...
    MN = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(1), MaxValueValidator(12)])
    DY = models.IntegerField(blank=True, null=True, validators=[MinValueValidator(1), MaxValueValidator(31)])
    RainD = models.FloatField(blank=True, null=True)
    TavgD = models.FloatField(blank=True, null=True,validators=[MinValueValidator(15), MaxValueValidator(45)])
    RHavgD = models.FloatField(blank=True, null=True)
    TminD = models.FloatField(blank=True, null=True,validators=[MinValueValidator(15), MaxValueValidator(45)])
    TmaxD = models.FloatField(blank=True, null=True,validators=[MinValueValidator(15), MaxValueValidator(45)])
    RHminD = models.FloatField(blank=True, null=True)
    RHmaxD = models.FloatField(blank=True, null=True)
    SR1avgF =  models.FloatField(blank=True, null=True)
    SR1minF =  models.FloatField(blank=True, null=True)
    SR1maxF =  models.FloatField(blank=True, null=True)
    Notes = models.TextField(blank=True, null=True)  
